...
<section class="admin-edit-showtime">
    ...
    <form action="admin-edit-showtime.php?id=<?php echo $showtime_id; ?>" method="post" class="admin-showtime-form">
        ...
        <div class="form-group">
            ...
            <input type="date" id="show_date" name="show_date" value="<?php echo $showtime['show_date']; ?>" min="<?php echo date('Y-m-d'); ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="ticket_price" name="ticket_price" value="<?php echo $showtime['ticket_price']; ?>" min="1" step="1000" required>
        </div>
